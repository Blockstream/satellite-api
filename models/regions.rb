...
class Region < ActiveRecord::Base
  ...
  enum number: [:north_america, :south_america, :africa, :europe, :asia_c, :asia_ku]
  
  REGIONS = {}
    
  seed_regions = [
    {number: 0, satellite_name: 'Galaxy 18', coverage: 'North America', has_receiver: true},
    {number: 1, satellite_name: 'Eutelsat 113', coverage: 'South America', has_receiver: true},
    ...
    {number: 4, satellite_name: 'Telstar 18V C', coverage: 'Asia', has_receiver: true},
    {number: 5, satellite_name: 'Telstar 18V Ku', coverage: 'Asia', has_receiver: true},
  ]
